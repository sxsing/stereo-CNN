...
function create_model(max_dips, nChannel)
	...
	ConvBNReLU(c,32, 5,5)
	ConvBNReLU(32,32,5,5)--:add(nn.Dropout(0.4))
	ConvBNReLU(32,64,5,5)--:add(nn.Dropout(0.4))
	ConvBNReLU(64,64,5,5)--:add(nn.Dropout(0.4))
	ConvBNReLU(64,64,5,5)--:add(nn.Dropout(0.4))
	ConvBNReLU(64,64,5,5)--:add(nn.Dropout(0.4))
	ConvBNReLU(64,64,5,5)--:add(nn.Dropout(0.4))
	ConvBNReLU(64,64,5,5)--:add(nn.Dropout(0.4))
	-- ConvBNReLU(128,128,3,3)--:add(nn.Dropout(0.4))
	bottom_left:add(nn.SpatialConvolution(64, 64, 5, 5))
