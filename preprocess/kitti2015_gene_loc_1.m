function [ty1, ty2] = kitti2015_gene_loc_1(tr_num, val_num, psz, half_range, saveDir, seed)
addpath('devkit_2015')

if strcmp(computer, 'MACI64')
    data_root = '/Users/wenjie/data/kitti_scene_flow/training';
else
    data_root = '/ais/gobi3/datasets/kitti/scene_flow/training';
end

data_root = '/home/mmcom/stereo-matching/cvpr16/dataset/training';

if ~exist(saveDir, 'dir') %bug fixed
    mkdir(saveDir);
end
...
noc_occ = 'noc';
rng(seed);
fn_idx = randperm(tr_num+val_num)-1;
% fn_idx = load(perm_fn);
