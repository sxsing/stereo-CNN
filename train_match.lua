...
opt = lapp[[
    ...
    --weight_epoch             (default 20)                  save weight at every 'weight_epoch'
    --max_epoch                (default 480)                 maximum number of iterations
    ...
    --num_val_loc              (default 1000)              number test patch pair
    --opt_method               (default 'adagrad')             sgd, adagrad, adam
...
function evaluate()
    ...
    local l, r, tar = my_dataset:get_eval_cuda()   --l,r: each has 10000 patch 
